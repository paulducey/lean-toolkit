...
Append the block from `docs/CLOSING-BLOCK.md` (also copied at `resources/closing-block.md`), filled in for this job. The first bullet under "what still needs a human" must point at any `[NEEDS GEMBA]` placeholders left in the sheet.
