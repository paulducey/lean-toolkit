...
Append the block from `docs/CLOSING-BLOCK.md`, filled in for this analysis. The first bullet under "what still needs a human" should name the most important unverified assumption — the one that, if wrong, would change the root cause entirely.
